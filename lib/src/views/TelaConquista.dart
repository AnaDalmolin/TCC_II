                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                      ...
                      for (var i = 0; i < snapshot.data!.docs.length; i++) {
                        var docFor = snapshot.data!.docs[i];
                        var dataFor = docFor.data() as Map;
                        if (dataFor['indentificador'] == 'FinalizarObjetivo') {
                          concluida = true;
                        }
                      }
                      return Container(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                      ...
                      for (var i = 0; i < snapshot.data!.docs.length; i++) {
                        var docFor = snapshot.data!.docs[i];
                        var dataFor = docFor.data() as Map;
                        if (dataFor['indentificador'] == 'DepositoRealizado') {
                          concluida = true;
                        }
                      }
                      return Container(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasError) {
                      ...
                      for (var i = 0; i < snapshot.data!.docs.length; i++) {
                        var docFor = snapshot.data!.docs[i];
                        var dataFor = docFor.data() as Map;
                        if (dataFor['indentificador'] == 'SaqueRealizado') {
                          concluida = true;
                        }
                      }
                      return Container(
